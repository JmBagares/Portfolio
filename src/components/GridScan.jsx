...
export default function GridScan({
  ...
  const pushScan = (time) => {
    ...
    if (materialRef.current) {
      ...
      for (let index = 0; index < arr.length && index < maxScans; index += 1) {
        buf[index] = arr[index]
      }
  ...
  useEffect(() => {
    ...
    const onMove = (event) => {
      ...
      yawTarget.current = nx * depthResponse
      tiltTarget.current = ny * depthResponse * 0.55
    }
  ...
  }, [depthResponse, enableGyro, scanOnClick, snapBackDelay])
